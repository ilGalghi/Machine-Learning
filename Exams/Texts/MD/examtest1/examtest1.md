...
- 1. Provide a formal definition of a maximum likelihood (ML) hypothesis, explaining in details all the terms used in the formula.
...
- 1. Explain how a kernelized regression model can be obtained based on the equations provided above.
- 2. Provide a definition of the Gram matrix for the kernelized regression model.
